             ...
             <div class="row d-flex justify-content-between">
                         ...
                         <div class="single-footer-caption">
                             ...
                             <div class="footer-tittle">
                                 <div class="footer-pera">
                                     <p>Tòa soạn: Tòa nhà C'Land - 156 Xã Đàn 2, Đống Đa, Hà Nội
                                        Hotline: 19001081 (8-17h) | 0923457788 (ngoài giờ HC)
                                        © 1997 Báo VietNamNet. All rights reserved.
                                        Chỉ được phát hành lại thông tin từ website này khi có sự
                                        đồng ý bằng văn bản của báo VietNamNet.</p>
                                 </div>
                             </div>
                             <!-- social -->
                 ...
                 <div class="col-xl-3 col-lg-3 col-md-4  col-sm-6">
                     <div class="single-footer-caption mt-60">
                         <div class="footer-tittle">
                             <h4>AZnews</h4>
                             <p>Công ty Cổ phần Truyền thông AZnews</p>
                             <!-- Form -->
