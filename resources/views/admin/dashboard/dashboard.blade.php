            ...
            <div class="container-fluid">
                <div class="row">
                        ...
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text">Bài Viết Mới </div>
                                    <div class="stat-digit"></i>+ 242</div>
                                </div>
                                <div class="progress">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text">Bài viết chưa duyệt</div>
                                    <div class="stat-digit"> </i>+ 132</div>
                                </div>
                                <div class="progress">
                        ...
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    ...
                                    <div class="stat-digit"> </i>+ 504</div>
                                </div>
                                <div class="progress">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text">Lượt truy cập website</div>
                                    <div class="stat-digit"> </i>+ 3350</div>
                                </div>
                                <div class="progress">
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-8">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Thống kê lượt xem các năm</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4">
                        <div class="card">
                            <div class="card-body text-center">
                                <div class="m-t-10">
                                    <h4 class="card-title">Tổng lượt truy cập website</h4>
                                ...
                                <ul class="widget-line-list m-b-15">
                                    <li class="border-right">92% <br><span class="text-success"><i
                                                class="ti-hand-point-up"></i> Thành viên</span></li>
                                    <li>8% <br><span class="text-danger"><i
                                                class="ti-hand-point-down"></i>Khách</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Thiết bị truy cập</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="item">
                                            <div class="testimonial-content">
                                                ...
                                                <div class="media">
                                                    ...
                                                    <img class="testimonial-author-img ml-3" src="{{ asset('html-admin/images/avatar/1.png') }}" alt="" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="item">
                                    ...
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="round-img">
                                                        <a href=""><img width="35" src="{{ asset('html-admin/images/avatar/1.png') }}" alt=""></a>
                                                    </div>
                                                </td>
                                                <td>Lew Shawon</td>
