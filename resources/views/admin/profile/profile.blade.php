            ...
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Cá nhân</a></li>
                            ...
                            <div class="profile-head">
                                <div class="photo-content">
                                    ...
                                    <div class="profile-photo">
                                        <img src="{{ asset('upload/admin/avatar/' .Auth::user()->avatar_path) }}" class="img-fluid rounded-circle" alt="" style="width: 196px; height: 196px;  object-fit: cover;">
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="profile-blog pt-3 border-bottom-1 pb-1">
                                    ...
                                    <img src="{{ asset('html-admin/images/profile/1.jpg') }}" alt="" class="img-fluid mt-4 mb-4 w-100">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-lg-4 col-xl-4 col-sm-4 col-6 int-col">
                                            <a href="javascript:void()" class="interest-cat">
                                                <img src="{{ asset('html-admin/images/profile/2.jpg') }}" alt="" class="img-fluid">
                                                <p>Shopping Mall</p>
                                            </a>
                                        </div>
                                        <div class="col-lg-4 col-xl-4 col-sm-4 col-6 int-col">
                                            <a href="javascript:void()" class="interest-cat">
                                                <img src="{{ asset('html-admin/images/profile/3.jpg') }}" alt="" class="img-fluid">
                                                <p>Photography</p>
                                            </a>
                                        </div>
                                        <div class="col-lg-4 col-xl-4 col-sm-4 col-6 int-col">
                                            <a href="javascript:void()" class="interest-cat">
                                                <img src="{{ asset('html-admin/images/profile/4.jpg') }}" alt="" class="img-fluid">
                                                <p>Art &amp; Gallery</p>
                                            </a>
                                        </div>
                                        <div class="col-lg-4 col-xl-4 col-sm-4 col-6 int-col">
                                ...
                                <div class="profile-news mt-4 pb-3">
                                    ...
                                    <div class="media pt-3 pb-3">
                                        <img src="{{ asset('html-admin/images/profile/5.jpg') }}" alt="image" class="mr-3">
                                    ...
                                    <div class="media pt-3 pb-3">
                                        <img src="{{ asset('html-admin/images/profile/6.jpg') }}" alt="image" class="mr-3">
                                        <div class="media-body">
                                            <h5 class="m-b-5">John Tomas</h5>
                                            <p>I shared this on my fb wall a few months back, and I thought I'd share it here again because it's such a great read</p>
                                        </div>
                                    ...
                                    <div class="media pt-3 pb-3">
                                        <img src="{{ asset('html-admin/images/profile/7.jpg') }}" alt="image" class="mr-3">
                                        <div class="media-body">
                                            <h5 class="m-b-5">John Tomas</h5>
                                            <p>I shared this on my fb wall a few months back, and I thought I'd share it here again because it's such a great read</p>
                                        </div>
                                ...
                                <div class="profile-tab">
                                    <div class="custom-tab-1">
                                        <ul class="nav nav-tabs">
                                            <li class="nav-item"><a href="#my-posts" data-toggle="tab" class="nav-link active show">Bài viết</a>
                                            </li>
                                            <li class="nav-item"><a href="#about-me" data-toggle="tab" class="nav-link">Giới thiệu</a>
                                            </li>
                                            ...
                                            <div id="my-posts" class="tab-pane fade active show">
                                                <div class="my-post-content pt-3">
                                                    ...
                                                    <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                        <img src="{{ asset('html-admin/images/profile/8.jpg') }}" alt="" class="img-fluid">
                                                    ...
                                                    <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                        <img src="{{ asset('html-admin/images/profile/9.jpg') }}" alt="" class="img-fluid">
                                                        <a class="post-title" href="javascript:void()">
                                                            <h4>Collection of textile samples lay spread</h4>
                                                        </a>
                                                        <p>A wonderful serenity has take possession of my entire soul like these sweet morning of spare which enjoy whole heart.A wonderful serenity has take possession of my entire soul like these sweet morning
                                                    ...
                                                    <div class="settings-form">
                                                        ...
                                                        <form action="{{ route('admin.update') }}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="file" class="form-control" name="avatar_path">
                                                            </div>
                                                            {{-- <div class="form-row">
                                                                <div class="form-group col-md-6">
                                                                    <label>City</label>
